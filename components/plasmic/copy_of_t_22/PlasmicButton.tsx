...
import sty from "./PlasmicButton.module.css"; // plasmic-import: HO-X_0IZqCJj/css
  ...
  return (
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootrounded_size_large_colors_black_showEndIcon]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "colors", "black") &&
            hasVariant($state, "size", "large") &&
            hasVariant($state, "rounded", "rounded"),
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__dbh0N, {
            [sty.freeBoxiconOnly__dbh0NwI9VT]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBoxshowEndIcon__dbh0NtzbrF]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxshowStartIcon__dbh0NkAKvX]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),
            [sty.freeBoxsize_large__dbh0Ndd6Rw]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__dbh0N56IwC]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <MenuIcon
                className={classNames(projectcss.all, sty.svg__zbN8)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox___9thK, {
            [sty.freeBoxshowEndIcon___9thKtzbrF]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxsize_small___9thK56IwC]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__rnlAn)}
                    role={"img"}
                  />
                ),
