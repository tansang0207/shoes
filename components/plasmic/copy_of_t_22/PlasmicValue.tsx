...
import sty from "./PlasmicValue.module.css"; // plasmic-import: UctlctSR9cQF/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: T-1ePTX5TAsK/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__vmYtB, {
          [sty.freeBoxcenter__vmYtBov4De]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom__vmYtBsrZH]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__hgZ3C)}>
          {renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__mBpvB)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__avMNu, {
          [sty.freeBoxcenter__avMNuov4De]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__avMNuok0BI]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__fz9QE, {
            [sty.freeBoxcenter__fz9QEov4De]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__fz9QEok0BI]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button___2M9Z4, {
                  [sty.buttonwithButton___2M9Z4Ok0BI]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__l8Jeg)}
                    role={"img"}
                  />
                }
                rounded={true}
